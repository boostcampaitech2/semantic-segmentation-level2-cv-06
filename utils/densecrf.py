...
def crf(original_image, mask_img):
    ...
    d.addPairwiseGaussian(sxy=POS_XY_STD, compat=POS_W, kernel=dcrf.DIAG_KERNEL, normalization=dcrf.NORMALIZE_SYMMETRIC)

    # This adds the color-dependent term, i.e. features are (x,y,r,g,b).
    d.addPairwiseBilateral(sxy=Bi_XY_STD, srgb=Bi_RGB_STD, rgbim=original_image.copy(), compat=Bi_W)
...
df.to_csv(OUTPUT_PATH+f'crf{POS_W}_{POS_XY_STD}_{Bi_W}_{Bi_XY_STD}_{Bi_RGB_STD}.csv', index=False)
